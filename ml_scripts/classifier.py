...
previsores_treinamento, previsores_teste, classe_treinamento, classe_teste = sk.model_selection.train_test_split(previsores, classe, test_size=test_percentage, random_state=0)
...
scores = sk.model_selection.cross_val_score(classificador,previsores,classe, cv=5 )
# testa o modelo
